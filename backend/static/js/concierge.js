...
// No mobile, o 360 foi substituído por peek scroll nativo
...
```
// No mobile: scroll nativo cuida do arraste
if (isMobileView()) return;
...
// ── Mobile: ativa sync dos dots com scroll nativo ──
if (isMobileView()) {
    clearInterval(lc360Timer);
    const track = document.getElementById('lc360-track');
    if (track) {
